			...
			<div class="col-xs-12">
				<div class="box">
					<div class="box-header">
						<button type="button" class="btn btn-success btn-sm" data-toggle="modal" data-target="#addTax"><i class="fa fa-plus"></i> Tambah</button>
					</div>
					<!-- /.box-header -->
								...
								if (!empty($tax)) {
									...
									foreach ($tax as $row):
										...
										<tr>
											...
											<td>
												<a href="<?php echo site_url('manage/tax/edit/' . $row['tax_id']) ?>" class="btn btn-xs btn-warning" data-toggle="tooltip" title="Edit"><i class="fa fa-edit"></i></a>
												
												<a href="#delModal<?php echo $row['tax_id']; ?>" data-toggle="modal" class="btn btn-xs btn-danger"><i class="fa fa-trash" data-toggle="tooltip" title="Hapus"></i></a>
											</td>	
										</tr>
										<div class="modal modal-default fade" id="delModal<?php echo $row['tax_id']; ?>">
												...
												<div class="modal-content">
													<div class="modal-header">
														...
														<div class="modal-footer">
															<?php echo form_open('manage/tax/delete/' . $row['tax_id']); ?>
															<input type="hidden" name="delName" value="<?php echo $row['tax_name']; ?>">
		...
		<div class="modal fade" id="addTax" role="dialog">
			<div class="modal-dialog modal-md">
				<div class="modal-content">
					...
					<?php echo form_open('manage/tax/add_glob', array('method'=>'post')); ?>
					<div class="modal-body">
						    <div id="p_scents_tax">
								<div class="row">
									<div class="col-md-6">
							...
							<h6 ><a href="#" class="btn btn-xs btn-success" id="addScnt_tax"><i class="fa fa-plus"></i><b> Tambah Baris</b></a></h6>
						</div>
						<div class="modal-footer">
