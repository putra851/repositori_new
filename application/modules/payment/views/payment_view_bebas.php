			...
			<div class="col-xs-12"> 
				<div class="box box-primary">
					...
					<div class="col-sm-10">
						...
						<a class="btn btn-warning btn-sm" href="<?php echo site_url('manage/payment/edit_payment_bebas_batch/' . $payment['payment_id']) ?>" data-toggle="tooltip" title="Ubah Tarif per Kelas"><span class="fa fa-edit"></span> Edit Tarif Bebas per Kelas</a>
							...
							<tbody>
								...
								foreach ($student as $row):
									...
									<tr>
										...
										<td>
											<a href="<?php echo site_url('manage/payment/edit_payment_bebas/'. $row['payment_payment_id'].'/'.$row['student_student_id'].'/'.$row['bebas_id']) ?>" class="btn btn-xs btn-warning" data-toggle="tooltip" title="Ubah Tarif per Santri"><i class="fa fa-edit"></i></a>
...
<div class="modal fade" id="editBanyak" role="dialog">
	<div class="modal-dialog modal-md">
		<div class="modal-content">
            ...
            <?php echo form_open('manage/payment/update_payment_bebas_batch/', array('method'=>'post')); ?>
				...
				<div class="form-group">
					<label for="" class="col-sm-4 control-label">Tarif Bebas Baru (Rp.)</label>
					<div class="col-sm-8">
						<input type="text" placeholder="Nominal Tarif Baru" name="bebas_bill" class="form-control" required>
						<br>
					</div>
					<div class="col-sm-12">
						<h5>&nbsp;&nbsp;&nbsp;
						<b>*) NB : Tarif yang sudah lunas tidak akan berubah</b></h5>
					</div>
				</div>
...
<div class="modal fade" id="hapusBanyak" role="dialog">
	<div class="modal-dialog modal-md">
		<div class="modal-content">
			...
			<div class="modal-body">
            <?php echo form_open('manage/payment/delete_payment_bebas_batch/', array('method'=>'post')); ?>
