						...
						<div class="box-body table-responsive">
							...
							<table class="table">
								<tbody>
									...
									<tr>
										<td><strong>Tarif Lama (Rp.)</strong></td>
										<td><input autofocus="" type="text" required="" name="tarif_lama" placeholder="Masukan Tarif Lama" class="form-control">
										</td>
									</tr>
									<tr>
										<td><strong>Tarif Baru (Rp.)</strong></td>
										<td><input type="text" required="" name="bebas_bill" placeholder="Masukan Tarif Baru" class="form-control">
										</td>
									</tr>
									<tr>
									    <td colspan="2">
									    <h5>1) Tarif yang diubah adalah tarif dengan tarif lama sesuai inputan</h5>
									    <h5>2) Tarif yang sudah lunas tidak akan berubah</h5>
									    </td>
									</tr>
