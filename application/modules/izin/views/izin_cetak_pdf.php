	...
	<table>
		...
		<table style="border-style: solid;">
			...
			<tr>
				...
				<td style="border-bottom: 1px solid;"><?php echo pretty_date($row['izin_date'], 'd F Y', false) ?></td>
				<td style="border-bottom: 1px solid;"><?php echo $row['izin_time'] ?></td>
			</tr>
			<?php 
				$i++;
				endforeach ?>
			<tr>
				<td colspan="2" style="background-color: #dedede; font-weight:bold; border-bottom: 1px solid;">Total Izin</td>
				<td style="background-color: #dedede;font-weight:bold;border-bottom: 1px solid;">
				    <?php    
						foreach ($izinSum as $row){
						    echo $row['izinSum'] . ' Kali';
						}
					?>
				</td>
			</tr>
