...
header("Content-Disposition: attachment; filename=Rekap_Tabungan_T.A._".$periode."_Unit_".$majors."_Kelas_".$class.".xls");
...
<table style='width: 277mm;'>
	<tr>
		...
		<td colspan="3" style='width: 93mm; font-size: 10pt; text-align: center' valign='top' align='center'><b><?php echo 'Rekap Tabungan' ?></b></td>
...
<table>
<tr>
	<td colspan='5' align='right' style='font-size: 10pt; padding: 1px; border-top: 0px solid #999999; border-bottom: 0px solid #999999;'></td>
