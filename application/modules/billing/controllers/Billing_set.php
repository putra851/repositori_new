    ...
    public function send(){
        if ($_POST == TRUE) {
            ...
            if(isset($santri['student_parent_phone']) AND $santri['student_parent_phone'] != '+62' AND $total != 0){
                ...
                $pesan = 'Perihal :'."\n".'Pemberitahuan administrasi santri.'."\n\n".'Assalamualaikum wr.wb' . "\n\n" . 'Salam silaturahmi kami sampaikan.' . "\n\n" . "Dengan ini kami dari kepengurusan *The Holistic Tahfidz Centre PESANTREN BAQU* menyampaikan Bahwa :  administrasi santri A/n " . $santri['student_full_name'] . ', Kelas '  . $santri['class_name'] . ', yang harus di LUNASI sejumlah Rp ' . number_format($total, 0, ",", ".") . "\n\n" . 
                    'Adapun untuk kejelasan perincian silahkan hubungi wa Pesantren BaQu' . "\n\n" . 'http://wa.me/' . $wa_center['setting_value'] . "\n\n" . 'Semoga rezeki yang di tasyarufkan untuk biaya pendidikan putra putri dari bapak /ibu, akan menjadi keunggulan derajat kelak di hadapan Allah dan semoga putra putri bapak/ibu menjadi Sholeh  Sholihah.' ."\n\n" .
                ...
                $key1='fce9862deac8554e58028c35011e14214b47496d05fbd61c';
