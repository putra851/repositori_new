	...
	<p class="alamat"><?php echo $setting_address['setting_value'] ?><br>
		...
		<table>
			<tbody>
				...
				<tr>
    			    <td></td>
    				<td style="width: 200px;text-align: center;">Bendahara</td>
    			</tr>
				<tr>
					<td></td>
					<td>&nbsp;</td>
    			...
    			<tr>
    			    <td></td>
    				<td style="width: 200px;text-align: center;"><b><?php echo ucfirst($setting_nama_bendahara['setting_value']); ?></b></td>
    			</tr>
    			<tr>
    			    <td></td>
    				<td style="width: 200px;text-align: center;">NIP. <?php echo ucfirst($setting_nip_bendahara['setting_value']); ?></td>
    			</tr>
			</tbody>
		</table>
