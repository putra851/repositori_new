...
// View data detail
  ...
  function payout_finish(){
    ...
    if(isset($student['student_parent_phone']) AND $student['student_parent_phone'] != "+62"){
        ...
        $demonstran             = $this->db->query("SELECT registrasi_school, registrasi_phone FROM registrasi WHERE registrasi_email = '$email'")->row_array();
        ...
        $params_msg['pesan']    = 'Terima kasih, Pembayaran ' . $demonstran['registrasi_school'] . ' a/n ' . $student['student_full_name'] . ', Kelas ' .$student['class_name'] . ', telah kami terima Tanggal ' . $tanggal_ini . ' sejumlah '.number_format($total) . ' Referensi ID : ' . $noref  . "\n\n" .
            'Download kwitansi : ' . base_url() . 'payout/cetakBukti?r=' . $nis_enc . '&d=' . $date_enc .  '&f=' . $noref_enc . "\n\n" .
            'Nomor WA Pesantren : http://wa.me/' . $demonstran['registrasi_phone'];
        ...
        //$keypprq = 'd33118fee8ea054dc0390c387bdb91839f7b9d04d2bd34bf';
