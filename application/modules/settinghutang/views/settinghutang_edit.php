							...
							<table class="table">
								<tbody>
									<tr>
										...
										<td><input type="text" class="form-control" value="<?php echo $kreditur['employee_name'] ?>" readonly>
										</td>
									</tr>
									<tr>
										<td><strong>Posisi</strong></td>
										<td><input type="text" class="form-control" value="<?php echo $kreditur['position_name'] ?>" readonly>
										</td>
									</tr>
									<tr>
										<td><strong>Tarif (Rp.)</strong></td>
										<?php foreach ($hutang as $row) { ?>
										<td><input autofocus="" type="text" id="" name="hutang_bill" placeholder="Masukan Tarif" value="<?php echo $row['hutang_bill'] ?>" class="form-control">
										</td>
										<?php } ?>
									</tr>
									<tr>
