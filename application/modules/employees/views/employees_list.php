						...
						<?php if ($this->session->userdata('uroleid') != USER) { ?>
							<table>
								<tr>
									...
									<td>
										<button type="submit" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#printEmployee"><span class="fa fa-print"></span> Cetak</button>
									</td>
								</tr>
							</table>
					</div>
					<div class="modal fade" id="printEmployee" role="dialog">
						<div class="modal-dialog modal-md">
							<div class="modal-content">
								...
								<form action="<?php echo base_url(); ?>manage/employees/print_employees" method="post" target="_blank">
									<div class="modal-body">
										<label>Unit Sekolah</label>
										<select required="" id="modal_majors" name="modal_majors" id="modal_majors" class="form-control">
										...
										<div id="div_class">
											<select required="" id="modal_posision" name="modal_posision" class="form-control">
