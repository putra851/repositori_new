...
<body>
    <table style='border-bottom: 1px solid #999999; padding-bottom: 10px; width: 277mm;'>
		...
		<table style='width: 277mm;'>
			<tr>
			    <td style='width: 87mm; font-size: 8pt; text-align: center' valign='center'></td>
				<td style='width: 113mm; font-size: 8pt; text-align: center' valign='top' align='center'><b><?php echo 'Laporan Gaji Guru dan Karyawan-'.$setting_school['setting_value'].' T.A '.$period['period_start'].'/'.$period['period_end']; ?></b></td>
				<td style='width: 87mm; font-size: 8pt;' align='right'></td>
			</tr>
			<tr>
			    <td style='font-size: 8pt; text-align: center' valign='center'></td>
				<td style='font-size: 8pt; text-align: center' valign='top' align='center'><b><?php echo 'Bulan : '.$month['month_name'].' '.$th; ?></b></td>
