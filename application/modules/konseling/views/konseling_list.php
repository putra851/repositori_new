					...
					<div class="box-body">
						<div class="nav-tabs-custom">
							<ul class="nav nav-tabs">
								<li class="active"><a href="#tab_1" data-toggle="tab">Tambah Kebaikan/Pelanggaran</a></li>
								<li><a href="#tab_2" data-toggle="tab">Laporan Catatan Santri</a></li>
							...
							<div class="tab-content">
								<div class="tab-pane active" id="tab_1">
                					...
                					<div class="row">
									    ...
									    <?php echo form_open('manage/konseling/add', array('method'=>'post')); ?>
                					
                    					<?php if(isset($f['n'])){ ?>
                    					<input type="hidden" name="konseling_period_id" value="<?php echo $f['n']?>">
                    					<input type="hidden" name="konseling_student_nis" value="<?php echo $f['r']?>">
                    					<?php } ?>
                    					
                					
										<?php foreach ($siswa as $row): ?>
											<?php echo (isset($f['n']) AND $f['r'] == $row['student_nis']) ? 
											'<input type="hidden" name="konseling_student_id" value='.$row['student_id'].'>' : '' ?> 
										<?php endforeach; ?>
                					    ...
                					    <div class="col-md-4">
                    						<div class="form-group">
                    							...
                    							<div class="input-group date " data-date="" data-date-format="yyyy-mm-dd">
                    								...
                    								<input class="form-control md-3" required="" type="text" name="konseling_date" value="<?php echo date("Y-m-d") ?>" placeholder="Tanggal Setor">
                    							</div>
                    						</div>
                					    </div>
                					    ...
                					    <div class="col-md-4">
                						<div class="form-group">
                							<label>Kebaikan/Pelanggaran</label>
                							<input type="text" class="form-control" required="" name="konseling_foul" class="form-control" placeholder="Kebaikan/Pelanggaran">
                						</div>
                						</div>
                						
                					    <div class="col-md-4">
                						<div class="form-group">
                							<label>Apresiasi/Tindakan</label>
                							<input type="text" class="form-control" required="" name="konseling_action" class="form-control" placeholder="Apresiasi/Tindakan">
                						</div>
                					    </div>
                					 ...
                					 <!--   <div class="col-md-3">-->
                						<!--<div class="form-group">-->
                						<!--	<label>Poin</label>-->
                						<!--	<input type="number" class="form-control" required="" name="konseling_poin" class="form-control" placeholder="Poin">-->
                						<!--</div>-->
                					 <!--   </div>-->
                						...
                						<div class="form-group">
                							<label>Catatan</label>
                							<input type="text" class="form-control" required="" name="konseling_note" class="form-control" placeholder="Catatan">
                						</div>
                					    </div>
										...
										<table id="dtable" class="table table-bordered" style="white-space: nowrap;">
											...
											<tbody>
												...
												<tr>
													...
													<!--<td><?php //echo $row['konseling_poin'] ?></td>-->
													<td><?php echo $row['konseling_note'] ?></td>
													<td>
												<a href="#delCatatanSantri<?php echo $row['konseling_id']; ?>" data-toggle="modal" class="btn btn-xs btn-danger"><i class="fa fa-trash" data-toggle="tooltip" title="Hapus"></i></a>
													</td>
												</tr>
		
										<div class="modal modal-default fade" id="delCatatanSantri<?php echo $row['konseling_id']; ?>">
