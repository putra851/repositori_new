	...
	<table>
		...
		<table style="border-style: solid;">
			<tr>
				...
				<th style="border-top: 1px solid; border-bottom: 1px solid;">Kebaikan/Pelanggaran</th>
				<th style="border-top: 1px solid; border-bottom: 1px solid;">Apresiasi/Tindakan</th>
				<!--<th style="border-top: 1px solid; border-bottom: 1px solid;" align="center">Poin</th>-->
			...
			<tr>
				...
				<td style="border-bottom: 1px solid;"><?php echo pretty_date($row['konseling_date'], 'd F Y', false) ?></td>
				<td style="border-bottom: 1px solid;"><?php echo $row['konseling_foul'] ?></td>
				<td style="border-bottom: 1px solid"><?php echo $row['konseling_action'] ?></td>
				<!--<td style="border-bottom: 1px solid; text-align: left;"><?php //echo $row['konseling_poin'] . ' Poin' ?></td>-->
				<td style="border-bottom: 1px solid; text-align: left;"><?php echo $row['konseling_note'] ?></td>
			</tr>
			<?php 
				$i++;
				endforeach ?>
			<!--<tr>-->
			<!--	<td colspan="4" style="background-color: #dedede; font-weight:bold; border-bottom: 1px solid;">Total Poin</td>-->
			<!--	<td style="background-color: #dedede;font-weight:bold;border-bottom: 1px solid;">-->
			     <?php
				// 		foreach ($konselingSum as $row){
				// 		    echo $row['konselingSum'] . ' Poin';
				// 		}
			    ?>
			<!--	</td>-->
