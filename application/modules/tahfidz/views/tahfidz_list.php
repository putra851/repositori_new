							...
							<div class="tab-content">
								<div class="tab-pane active" id="tab_1">
                					...
                					<div class="row">
                						...
                						<div class="form-group">
                							<label>Ziadah</label>
                							<input type="text" class="form-control" required="" name="tahfidz_ziyadah" class="form-control" placeholder="Tmbah Hafalan">
                						</div>
                					    </div>
                						...
                						<div class="form-group">
                							<label>Ta'rir</label>
                							<input type="text" class="form-control" required="" name="tahfidz_tarir" class="form-control" placeholder="Murojaah">
                						</div>
                					    </div>
                						...
                						<div class="form-group">
                							<label>Arba'un</label>
                							<input type="text" class="form-control" required="" name="tahfidz_arbaun" class="form-control" placeholder="Latihan">
                						</div>
                					    </div>
										...
										<table class="table table-bordered" style="white-space: nowrap;">
											...
											<tbody>
												...
												<tr>
													...
													<td><?php echo $row['tahfidz_tarir'] ?></td>
													<td><?php echo $row['tahfidz_arbaun'] ?></td>
													<td>
