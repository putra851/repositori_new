	...
	<table>
		...
		<table style="border-style: solid;">
			<tr>
				...
				<th style="border-top: 1px solid; border-bottom: 1px solid;">Halaqoh 1</th>
				<th style="border-top: 1px solid; border-bottom: 1px solid;" align="center">Halaqoh 2</th>
				<th style="border-top: 1px solid; border-bottom: 1px solid;" align="center">Halaqoh 3</th>
			</tr>
			<?php
				$i =1;
			...
			<tr>
				...
				<td style="border-bottom: 1px solid"><?php echo $row['tahfidz_new_note'] ?></td>
				<td style="border-bottom: 1px solid; text-align: left;"><?php echo $row['tahfidz_murojaah'] ?></td>
				<td style="border-bottom: 1px solid; text-align: left;"><?php echo $row['tahfidz_murojaah_note'] ?></td>
			</tr>
			<?php 
				$i++;
				endforeach ?>
