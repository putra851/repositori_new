...
class Tahfidz_model extends CI_Model {
	...
	function get($params = array())
	{
		...
		$this->db->select('tahfidz_id, tahfidz_period_id, tahfidz_date, tahfidz_new, tahfidz_ziyadah, tahfidz_tarir, tahfidz_arbaun');
	...
	function add($data = array()) {
		...
		if(isset($data['tahfidz_ziyadah'])) {
			$this->db->set('tahfidz_ziyadah', $data['tahfidz_ziyadah']);
		}

		if(isset($data['tahfidz_tarir'])) {
			$this->db->set('tahfidz_tarir', $data['tahfidz_tarir']);
		}

		if(isset($data['tahfidz_arbaun'])) {
			$this->db->set('tahfidz_arbaun', $data['tahfidz_arbaun']);
		}
