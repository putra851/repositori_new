...
// Santri
    ...
    public function add(){
		if ($_POST == TRUE) {
			...
			$params['tahfidz_ziyadah']       = $this->input->post('tahfidz_ziyadah');
			$params['tahfidz_tarir']         = $this->input->post('tahfidz_tarir');
			$params['tahfidz_arbaun']        = $this->input->post('tahfidz_arbaun');
