...
header("Content-Disposition: attachment; filename=Rekap_Kesehatan_T.A._".$periode."_Unit_".$majors."_Kelas_".$class.".xls");
header("Pragma: no-cache");
header("Expires: 0");
?>
<table style='border-bottom: 1px solid #999999; padding-bottom: 10px; width: 277mm;'>
	<tr valign='top'>
		<td colspan="8" style='width: 55mm;' valign='middle'>
...
<table style='width: 277mm;'>
	<tr>
		...
		<td colspan="4" style='width: 93mm; font-size: 10pt; text-align: center' valign='top' align='center'><b><?php echo 'Rekap Kesehatan Santri' ?></b></td>
...
<table cellpadding='0' cellspacing='0' style='width: 277mm;'>
	<tr>
		...
		<td colspan="5" style='width: 110mm; font-size: 10pt;'> </td>
	</tr>
	<tr valign='top'>
