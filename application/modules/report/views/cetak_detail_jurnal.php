...
<html>
<head>
	<title><?php echo 'Laporan per Jenis Anggaran (Kas Tunai) per Tanggal '.pretty_date($ds, 'd/m/Y', FALSE).' Sampai '.pretty_date($de, 'd/m/Y', FALSE) ?></title>
</head>
<body>
<table style='border-bottom: 1px solid #999999; padding-bottom: 10px; width: 190mm;'>
		...
		<table style='width: 190mm;'>
			<tr>
				...
				<td style='width: 150mm; font-size: 8pt; text-align: center' valign='top' align='center'><b><?php echo 'Laporan per Jenis Anggaran (Kas Tunai) per Tanggal '.pretty_date($ds, 'd F Y', FALSE).' Sampai '.pretty_date($de, 'd F Y', FALSE) ?></b></td>
	    ...
	    echo '<b><font size="10px">Penerimaan</font></b> 
	        ...
	        echo '<tr>
	                <td style="padding: 1px; font-size: 8pt; text-align: left; width: 190mm">'.$row['account_code'].'-'.$row['account_description'];
                        ...
                        $detailBulan = $this->Jurnal_model->get_bulan($ds, $de, $majors_id, $paramBulan, $kasBulan);
                    echo '<table cellpadding="0" cellspacing="0" style="width: 190mm;">
				        ...
				        echo '<tr>
				                ...
				                <td style="padding: 1px; font-size: 8pt; text-align: left">'.wordwrap($res['student_full_name'],20,"<br>\n").'</td>
	        ...
	        echo '<tr>
	                <td style="padding: 1px; font-size: 8pt; text-align: left; width: 190mm">'.$row['account_code'].'-'.$row['account_description'];
                        ...
                        $detailFree = $this->Jurnal_model->get_free($ds, $de, $majors_id, $paramFree, $kasFree);
                        echo '<table cellpadding="0" cellspacing="0" style="width: 190mm;">
                			<tr>
                			    <th align="center" style="font-size: 8pt; width: 5mm; padding: 1px 0px 1px 0px; border-top: 1px solid #999999; border-bottom: 1px solid #999999;">No.</th>
                				<th align="center" style="font-size: 8pt; width: 20mm; padding: 1px 0px 1px 0px; border-top: 1px solid #999999; border-bottom: 1px solid #999999;">Tanggal</th>
	        ...
	        echo '<tr>
	                <td style="padding: 1px; font-size: 8pt; text-align: left; width: 190mm">'.$row['account_code'].'-'.$row['account_description'];
                        ...
                        $detailDebit = $this->Jurnal_model->get_debit($ds, $de, $majors_id, $paramDebit, $kasDebit);
                        echo '<table cellpadding="0" cellspacing="0" style="width: 190mm;">
                			<tr>
                				<th align="center" style="font-size: 8pt; width: 5mm; padding: 1px 0px 1px 0px; border-top: 1px solid #999999; border-bottom: 1px solid #999999;">No.</th>
                				<th align="center" style="font-size: 8pt; width: 20mm; padding: 1px 0px 1px 0px; border-top: 1px solid #999999; border-bottom: 1px solid #999999;">Tanggal</th>
				        ...
				        echo '<tr>
				                ...
				                <td style="padding: 1px; font-size: 8pt; text-align: left">'.wordwrap($res['debit_desc'],20,"<br>\n").'</td>
				                <td style="padding: 1px; font-size: 8pt; text-align: center">'.'-'.'</td>
				                <td style="padding: 1px; font-size: 8pt; text-align: center">'.'-'.'</td>
				                <td style="padding: 1px; font-size: 8pt; text-align: center">'.'-'.'</td>
	    ...
	    echo '<b><font size="10px">Pengeluaran</font></b>
	        ...
	        echo '<tr>
	                <td style="padding: 1px; font-size: 8pt; text-align: left; width: 190mm">'.$row['account_code'].'-'.$row['account_description'];
                        ...
                        $detailKredit = $this->Jurnal_model->get_kredit($ds, $de, $majors_id, $paramKredit, $kasKredit);
                        echo '<table cellpadding="0" cellspacing="0" style="width: 190mm;">
                			<tr>
                			    <th align="center" style="font-size: 8pt; width: 5mm; padding: 1px 0px 1px 0px; border-top: 1px solid #999999; border-bottom: 1px solid #999999;">No.</th>
                				<th align="center" style="font-size: 8pt; width: 20mm; padding: 1px 0px 1px 0px; border-top: 1px solid #999999; border-bottom: 1px solid #999999;">Tanggal</th>
				        ...
				        echo '<tr>
				                ...
				                <td style="padding: 1px; font-size: 8pt; text-align: left">'.wordwrap($res['kredit_desc'],20,"<br>\n").'</td>
				                <td style="padding: 1px; font-size: 8pt; text-align: center">'.'-'.'</td>
				                <td style="padding: 1px; font-size: 8pt; text-align: center">'.'-'.'</td>
				                <td style="padding: 1px; font-size: 8pt; text-align: center">'.'-'.'</td>
				                <td style="padding: 1px; font-size: 8pt; text-align: center">'.'-'.'</td>
	        ...
	        echo '<tr>
	                <td style="padding: 1px; font-size: 8pt; text-align: left; width: 190mm">'.$row['account_code'].'-'.$row['account_description'];
                        ...
                        $detailGaji = $this->Jurnal_model->get_kredit($ds, $de, $majors_id, $paramGaji, $kasGaji);
                        echo '<table cellpadding="0" cellspacing="0" style="width: 190mm;">
                			<tr>
                			    <th align="center" style="font-size: 8pt; width: 5mm; padding: 1px 0px 1px 0px; border-top: 1px solid #999999; border-bottom: 1px solid #999999;">No.</th>
                				<th align="center" style="font-size: 8pt; width: 20mm; padding: 1px 0px 1px 0px; border-top: 1px solid #999999; border-bottom: 1px solid #999999;">Tanggal</th>
