							...
							<div class="tab-content">
								<div class="tab-pane active" id="tab_1">
									...
									<div class="form-group">
										...
										<input type="text" class="form-control" value="<?php echo $inputFullnameValue ?>">
									</div>
									<div class="form-group">
								...
								<div class="tab-pane" id="tab_2">
									...
									<div class="form-group"> 
										<label >Kamar *</label>
										<input readonly="" type="text" class="form-control" value="<?php echo $student['madin_name'] ?>">
									</div>
								...
								<div class="tab-pane" id="tab_3">
									...
									<div class="form-group">
										<label>No. Whatsapp Orang Tua <small data-toggle="tooltip" title="Wajib diisi">*</small></label>
										<input name="student_parent_phone" type="text" class="form-control" value="<?php echo ($inputParPhoneValue == '+62' OR $inputParPhoneValue == NULL) ? '' : $inputParPhoneValue ?>" placeholder="No Handphone Orang Tua">
									</div>
								</div>
