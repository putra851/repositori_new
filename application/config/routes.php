...
$route['manage/([a-zA-Z_-]+)/data_trx/(:any)'] = '$1/$1_set/data_trx/$2';
$route['manage/([a-zA-Z_-]+)/cetakTrx/(:any)'] = '$1/$1_set/cetakTrx/$2';
$route['manage/(:any)/edit/(:num)'] = "$1/$1_set/add/$2";
$route['manage/(:any)/(:any)/edit/(:num)'] = "$1/$1_set/add_$2/$3";
$route['manage/(:any)/(:any)/(:any)/(:any)'] = "$1/$1_set/$2/$3/$4";
//$route['manage/(:any)/(:any)/(:any)/(:any)/(:any)'] = "$1/$1_set/$2/$3/$4/$5";
$route['manage/(:any)/(:any)/(:any)/(:any)/(:any)'] = "$1/$1_set/$2/$3/$4/$5";
$route['manage/(:any)/(:any)/(:any)/(:any)/(:any)/(:any)'] = "$1/$1_set/$2/$3/$4/$5/$6";
$route['manage/(:any)/(:any)/(:any)/(:any)/(:num)/(:num)/(:any)'] = "$1/$1_set/$2/$3/$4/$5/$6/$7";
$route['manage/(:any)/(:any)/(:any)/(:any)/(:num)/(:num)/(:num)/(:num)'] = "$1/$1_set/$2/$3/$4/$5/$6/$7/$8";
$route['manage/(:any)/(:any)/(:any)/(:any)/(:any)/(:any)/(:any)/(:any)/(:any)'] = "$1/$1_set/$2/$3/$4/$5/$6/$7/$8/$9";
