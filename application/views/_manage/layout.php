      ...
      <nav class="navbar navbar-static-top">
        ...
        <span class="logo-lg pull-left">
            ...
            <font size="4" color="white">
                <b>E-Pesantren <?php echo $resultName->name; ?></b>
            </font><br>
            <font size="2" color="white"><?php echo $resultAddress->address.' '.$resultDistrict->district.' - '.$resultCity->city.', Telp. '.$resultPhone->phone ?>
