		...
		<div class="container text-center">
			<div class="row">
				<div class="col-md-12">
					...
					<p class="lead mb-5 colr">SIM Pengelolaan Pesantren</p>
				</div>
				<div class="col-md-6">
				...
				<div class="col-md-6">
					<a href="https://s.id/ep_android_v270521" target="_blank">
					<div class="box">
						<i class="fa fa-mobile icon-menu"></i>
						<br>
						Download Android Wali Santri
					</div>
				</a>
				</div>
		    </div>
