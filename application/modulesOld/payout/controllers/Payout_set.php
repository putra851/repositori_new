...
// View data detail
  ...
  function payout_finish(){
    ...
    if(isset($student['student_parent_phone']) AND $student['student_parent_phone'] != "+62"){
        ...
        $params_msg['pesan']    = 'Terima kasih, Pembayaran ' . $student['majors_school_name'] . ' a/n ' . $student['student_full_name'] . ', Kelas ' .$student['class_name'] . ', telah kami terima Tanggal ' . $tanggal_ini . ' sejumlah '.number_format($total) . ' Referensi ID : ' . $noref  . "\n\n" .
