...
<body>
	...
	<p class="alamat"><?php echo $setting_address['setting_value'] ?><br>
		...
		<table style="padding-top: -5px; padding-bottom: 5px">
			<tbody>
				...
				<?php endforeach ?>
					...
					<td style="width: 5px;">:</td>
					<td style="width: 131px;"><?php echo pretty_date(base64_decode($f['d']),'d F Y',false)?></td>
				</tr>
				<tr>
					...
					<td style="width: 5px;">:</td>
					<td style="width: 131px;"><?php foreach ($period as $row):?> <?php echo ($case['kas_period'] == $row['period_id']) ? $row['period_start'].'/'.$row['period_end'] : '' ?><?php endforeach; ?></td>
				</tr>
				<tr>
		...
		<table style="border-style: solid;">
			...
			<tr>
				<td colspan="2" style="text-align: center;padding-top: 5px; padding-bottom: 5px;"><?php echo $setting_city['setting_value'] ?>, <?php echo pretty_date(base64_decode($f['d']),'d F Y',false) ?></td>
