	...
	<table>
		...
		<table style="border-style: solid;">
			<tr>
				...
				<th style="border-top: 1px solid; border-bottom: 1px solid;">Jumlah Hari</th>
			...
			<tr>
				...
				<td style="border-bottom: 1px solid;"><?php echo pretty_date($row['pulang_date'], 'd F Y', false) ?></td>
				<td style="border-bottom: 1px solid;"><?php echo $row['pulang_days'] . ' Hari' ?></td>
				<td style="border-bottom: 1px solid;"><?php echo $row['pulang_note'] ?></td>
			</tr>
			<?php 
				$i++;
				endforeach ?>
			<tr>
				<td colspan="3" style="background-color: #dedede; font-weight:bold; border-bottom: 1px solid;">Total Izin Pulang</td>
				<td style="background-color: #dedede;font-weight:bold;border-bottom: 1px solid;">
				    <?php    
						foreach ($pulangSum as $row){
						    echo $row['pulangSum'] . ' Hari';
						}
					?>
				</td>
			</tr>
