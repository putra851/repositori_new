			...
			<div class="col-md-12">
				<div class="box box-info">
					<div class="box-header with-border">
						<h3 class="box-title">Filter Data Kesehatan Santri</h3>
					</div><!-- /.box-header -->
					<div class="box-body">
				...
				<div class="box box-success">
					<div class="box-header with-border">
						...
						<?php if (isset($f['n']) AND isset($f['r'])) { ?>
							<a href="<?php echo site_url('manage/kesehatan/printBook' . '/?' . http_build_query($f)) ?>" target="_blank" class="btn btn-danger btn-xs pull-right">Cetak Buku Kesehatan</a>
						<?php } ?>
					</div><!-- /.box-header -->
					<div class="box-body">
						<div class="col-md-9">
							...
							<div class="tab-content">
								<div class="tab-pane active" id="tab_1">
                					...
                					<div class="row">
									    ...
									    <?php echo form_open('manage/kesehatan/add', array('method'=>'post')); ?>
                					
                    					<?php if(isset($f['n'])){ ?>
                    					<input type="hidden" name="kesehatan_period_id" value="<?php echo $f['n']?>">
                    					<input type="hidden" name="kesehatan_student_nis" value="<?php echo $f['r']?>">
                    					<?php } ?>
                    					
                					
										<?php foreach ($siswa as $row): ?>
											<?php echo (isset($f['n']) AND $f['r'] == $row['student_nis']) ? 
											'<input type="hidden" name="kesehatan_student_id" value='.$row['student_id'].'>' : '' ?> 
										<?php endforeach; ?>
                					    ...
                					    <div class="col-md-3">
                    						<div class="form-group">
                    							...
                    							<div class="input-group date " data-date="" data-date-format="yyyy-mm-dd">
                    								...
                    								<input class="form-control md-3" required="" type="text" name="kesehatan_date" value="<?php echo date("Y-m-d") ?>" placeholder="Tanggal Setor">
                    							</div>
                    						</div>
                					    </div>
                						...
                						<div class="form-group">
                							<label>Sakit</label>
                							<input type="text" class="form-control" required="" name="kesehatan_ill" class="form-control" placeholder="Sakit yang Diderita Santri">
                						</div>
                						</div>
                						...
                						<div class="form-group">
                							...
                							<input type="text" class="form-control" required="" name="kesehatan_cure" class="form-control" placeholder="Penanganan yang Diberikan">
                						</div>
                					    </div>
                						...
                						<div class="form-group">
                							...
                							<input type="text" class="form-control" required="" name="kesehatan_note" class="form-control" placeholder="Keterangan Sakit yang Diderita Santri">
                						</div>
                					    </div>
									...
									<div class="box-body table-responsive">
										<table class="table table-bordered" style="white-space: nowrap;">
											...
											<tbody>
												...
												<tr>
													<td><?php echo $i ?></td>
													<td><?php echo pretty_date($row['kesehatan_date'], 'd F Y', false) ?></td>
													<td><?php echo $row['kesehatan_ill'] ?></td>
													<td><?php echo $row['kesehatan_cure'] ?></td>
													<td><?php echo $row['kesehatan_note'] ?></td>
													<td>
												<a href="<?php echo base_url() . 'manage/kesehatan/cetakSurat/' . $row['kesehatan_id']; ?>" data-toggle="modal" class="btn btn-xs btn-default" target="_blank"><i class="fa fa-print" data-toggle="tooltip" title="Cetak"></i></a>
												<a href="#delKesehatan<?php echo $row['kesehatan_id']; ?>" data-toggle="modal" class="btn btn-xs btn-danger"><i class="fa fa-trash" data-toggle="tooltip" title="Hapus"></i></a>
													</td>
												</tr>
		
										<div class="modal modal-default fade" id="delKesehatan<?php echo $row['kesehatan_id']; ?>">
												...
												<div class="modal-content">
													<div class="modal-header">
														...
														<div class="modal-footer">
															<?php echo form_open('manage/kesehatan/delete/' . $row['kesehatan_id']); ?>
...
<script>
    function ambil_data(nis){
            ...
            window.location.href = '<?php echo base_url();?>manage/kesehatan?n='+thAjaran+'&r='+nisSantri;
      }
    ...
    function get_kelas(){
        ...
        $.ajax({ 
            url: '<?php echo base_url();?>manage/kesehatan/get_kelas',
            type: 'POST', 
            data: {
                    'id_majors': id_majors,
            },    
