				...
				<div class="box box-success">
					<div class="box-header">
						...
						<div class="row">
							...
							<?php if ($q AND !empty($kesehatan)) { ?>
							<a class="btn btn-success" target="_blank" href="<?php echo site_url('manage/kesehatan/kesehatan_excel' . '/?' . http_build_query($q)) ?>"><i class="fa fa-file-excel-o" ></i> Excel</a>
							<?php } ?>
						    </div>
					        </div>
					</div>
					...
					<div class="box-body table-responsive">
						<table id="dtable" class="table table-responsive table-bordered" style="white-space: nowrap;">
							...
							?>
								<tr>
									<td><?php echo $no++ ?></td>
									<td><?php echo pretty_date($row['kesehatan_date'], 'd/m/Y', false) ?></td>
									...
									<td><a href="<?php echo base_url() . 'manage/kesehatan/cetakSurat/' . $row['kesehatan_id']; ?>" target="_blank" class="btn btn-sm btn-danger"><i class="fa fa-print"></i> Cetak Surat</a></td>
								</tr>
							<?php endforeach ?>
                            </tbody>
						</table>
...
<script>
    function get_kelas(){
        ...
        $.ajax({ 
            url: '<?php echo base_url();?>manage/kesehatan/class_searching',
            type: 'POST', 
            data: {
                    'id_majors': id_majors,
            },    
    ...
    function get_siswa(){
        ...
        //alert(id_jurusan+id_kelas);
        $.ajax({ 
            url: '<?php echo base_url();?>manage/kesehatan/student_searching',
            type: 'POST', 
            data: {
                    'id_majors': id_majors,
                    'id_class': id_class,
