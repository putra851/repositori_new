			...
			<?php if ($f) { ?>
				...
				<div class="box box-success">
					...
					<div class="box-body">
						...
						<div class="col-md-3">
						    <center>
						    <a href="<?php echo base_url() . 'manage/izin/printBook/?n='.$f['n'].'&r=' . $f['r']; ?>" target="_blank" class="btn btn-sm btn-danger"><i class="fa fa-print"></i> Cetak Riwayat </a>
						    </center>
							<?php foreach ($siswa as $row): ?>
				...
				<div class="box box-primary">
					<div class="box-header with-border">
						<h3 class="box-title">Izin Keluar Santri</h3>
					</div><!-- /.box-header -->
					<div class="box-body">
						<div class="nav-tabs-custom">
							<ul class="nav nav-tabs">
								<li class="active"><a href="#tab_1" data-toggle="tab">Laporan Izin Keluar Santri</a></li>
								<li><a href="#tab_2" data-toggle="tab">Tambah Izin</a></li>
								<li><a href="#tab_3" data-toggle="tab">Rekap Laporan Izin Keluar Santri</a></li>
							</ul>
							<div class="tab-content">
									...
									<div class="box-body table-responsive">
										<table id="xtable" class="table table-bordered" style="white-space: nowrap;">
											...
											<tbody>
												...
												<tr>
													<td><?php echo $i ?></td>
													<td><?php echo pretty_date($row['izin_date'], 'd F Y', false) ?></td>
													<td><?php echo $row['izin_time'] ?></td>
													<td>
												<a href="<?php echo base_url() .  'manage/izin/cetakThermal/' . $row['izin_id']; ?>" class="btn btn-xs btn-default" target="_blank"><i class="fa fa-print" data-toggle="tooltip" title="Cetak"></i></a>
												<a href="#delIzin<?php echo $row['izin_id']; ?>" data-toggle="modal" class="btn btn-xs btn-danger"><i class="fa fa-trash" data-toggle="tooltip" title="Hapus"></i></a>
													</td>
												</tr>
		
										<div class="modal modal-default fade" id="delIzin<?php echo $row['izin_id']; ?>">
												...
												<div class="modal-content">
													<div class="modal-header">
														...
														<div class="modal-footer">
															<?php echo form_open('manage/izin/delete/' . $row['izin_id']); ?>
								...
								<div class="tab-pane" id="tab_2">
                					...
                					<div class="row">
									    ...
									    <?php echo form_open('manage/izin/add', array('method'=>'post')); ?>
                					
                    					<?php if(isset($f['n'])){ ?>
                    					<input type="hidden" name="izin_period_id" value="<?php echo $f['n']?>">
                    					<input type="hidden" name="izin_student_nis" value="<?php echo $f['r']?>">
                    					<?php } ?>
                    					
                					
										<?php foreach ($siswa as $row): ?>
											<?php echo (isset($f['n']) AND $f['r'] == $row['student_nis']) ? 
											'<input type="hidden" name="izin_student_id" value='.$row['student_id'].'>' : '' ?> 
										<?php endforeach; ?>
                					    ...
                					    <div class="col-md-4">
                    						<div class="form-group">
                    							...
                    							<div class="input-group date " data-date="" data-date-format="yyyy-mm-dd">
                    								...
                    								<input class="form-control md-3" required="" type="text" name="izin_date" value="<?php echo date("Y-m-d") ?>" placeholder="Tanggal Setor">
                    							</div>
                    						</div>
                					    </div>
                						...
                						<div class="form-group">
                							...
                							<input type="text" class="form-control" required="" name="izin_time_start" class="form-control" placeholder="Contoh 12.00" minlength="5" maxlength="5">
                						</div>
                						</div>
                						...
                						<div class="form-group">
                							...
                							<input type="text" class="form-control" required="" name="izin_time_end" class="form-control" placeholder="Contoh 13.00" minlength="5" maxlength="5">
                						</div>
                						</div>
...
<script>
    function ambil_data(nis){
            ...
            window.location.href = '<?php echo base_url();?>manage/izin?n='+thAjaran+'&r='+nisSantri;
      }
    ...
    function get_kelas(){
        ...
        $.ajax({ 
            url: '<?php echo base_url();?>manage/izin/get_kelas',
            type: 'POST', 
            data: {
                    'id_majors': id_majors,
            },    
