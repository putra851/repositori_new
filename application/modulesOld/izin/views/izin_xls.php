...
header("Content-Disposition: attachment; filename=Rekap_Izin_T.A._".$periode."_Unit_".$majors."_Kelas_".$class.".xls");
...
<table style='width: 277mm;'>
	<tr>
		...
		<td colspan="3" style='width: 93mm; font-size: 10pt; text-align: center' valign='top' align='center'><b><?php echo 'Rekap Izin' ?></b></td>
