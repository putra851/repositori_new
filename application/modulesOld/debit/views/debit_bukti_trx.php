...
<body>
	...
	if($num > 1){ ?>
        <font size=12px>
        Unit Sekolah : 
        <?php echo $sumDebit['majors_short_name'].'<br>' ?>
      <?php } ?>
	...
	<p class="alamat"><?php echo $setting_address['setting_value'] ?><br>
		...
		<table style="padding-top: -5px; padding-bottom: 5px">
			<tbody>
				<tr>
					...
					<td style="width: 130px;">Tanggal Pemasukan</td>
					<td style="width: 5px;">:</td>
		...
		<hr>
		<p class="detail">Dengan rincian pemasukan sebagai berikut:</p>
		...
		<table style="border-style: solid;">
			<tr>
				...
				<th colspan="2" style="border-top: 1px solid; border-bottom: 1px solid; text-align: center">Jumlah Pemasukan</th>
			</tr>
			<?php
				$i =1;
			...
			<tr>
				...
				<td style="border-bottom: 1px solid"><?php echo $row['debit_desc'] ?></td>
				<td style="border-bottom: 1px solid;">Rp. </td>
				<td style="border-bottom: 1px solid; text-align: right;"><?php echo number_format($row['debit_value'], 0, ',', '.') ?></td>
			</tr>
			<?php 
				$i++;
				endforeach ?>
			<tr>
				...
				<td style="background-color: #dedede; font-weight:bold; border-bottom: 1px solid;">Total Pemasukan</td>
				<td style="background-color: #dedede;font-weight:bold;border-bottom: 1px solid;">Rp. </td>
				<td style="background-color: #dedede; font-weight:bold;border-bottom: 1px solid; text-align: right;"><?php echo number_format($sumDebit['total'], 0, ',', '.') ?></td>
			</tr>
			<tr>
