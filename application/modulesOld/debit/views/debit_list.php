			...
			<div class="col-md-12">
				<div class="box">
					<div class="box-header">
						<a href="<?php echo site_url('manage/debit/trx') ?>"><button type="button" class="btn btn-success btn-sm"><i class="fa fa-plus"></i> Tambah</button></a>
							<br>
							<br>
								...
								if (!empty($debit)) {
									...
									foreach ($debit as $row):
										...
										<tr>
											...
											<td><?php echo $row['debit_kas_noref']; ?></td>
											<td><?php echo pretty_date($row['debit_date'],'d/m/Y',false); ?></td>
											...
											<td><?php echo $row['debit_tax']; ?> %</td>
											<td><?php echo $row['debit_item']; ?></td>
											<td><?php echo 'Rp. ' . number_format($row['debit_value']-($row['debit_value']*($row['debit_tax']/100)), 0, ',', '.') ?></td>
											<td>
											    <a href="<?php echo site_url('manage/debit/cetakTrx/' . $row['debit_kas_noref']) ?>" class="btn btn-xs btn-default" data-toggle="tooltip" title="Cetak Tranksaksi" target="_blank"><i class="fa fa-print"></i></a>
												...
												<div class="modal-content">
													<div class="modal-header">
														...
														<div class="modal-footer">
															...
															<input type="hidden" name="delNoref" value="<?php echo $row['debit_kas_noref']; ?>">
						...
						<div id="p_scents_debit">
							<div class="form-group">
								...
								<div class="input-group date " data-date="" data-date-format="yyyy-mm-dd">
									...
									<input class="form-control" required="" type="text" name="debit_date" placeholder="Tanggal Kas Masuk">
								</div>
							</div>
							<div class="row">
								<div class="col-md-3">
								...
								<div class="col-md-3">
									...
									<input  type="text" class="form-control" id="debit" required="" name="debit_value[]" class="form-control" placeholder="Jumlah">
								</div>
								<div class="col-md-3">
									<label>Keterangan *</label>
									<input type="text" required="" name="debit_desc[]" class="form-control" placeholder="Keterangan Kas Masuk">
								</div>
							</div>
						</div>
