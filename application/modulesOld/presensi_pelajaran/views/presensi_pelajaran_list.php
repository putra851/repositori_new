			...
			<div class="col-md-12">
				<div class="box box-success">
					<div class="box-header">
					    <h3><?php echo 'Presensi Pelajaran Bulan ' . $bulan['month_name'] . ' ' . $period['period_start'] . '/' . $period['period_end'] . ' Tanggal ' . pretty_date(date('Y-m-d'), 'l, d F Y' ,false); ?></h3>
        					...
        					<div class="box-body table-responsive">
        					    ...
        					    <table class="table">
        					        ...
        					        <tr>
        					            <td>Guru/Pengajar</td>
        					            <td>:</td>
        					            <td><?php echo $pelajaran['employee_name'] ?></td>
        					        </tr>
        					    </table>
            					<?php echo form_open('manage/presensi_pelajaran/add_glob', array('method'=>'post')); ?>
            					...
            					<input type="hidden" name="lesson_id" value="<?php echo $q['l'] ?>"></td>
            					<table class="table table-responsive table-bordered" style="white-space: nowrap;">
            						    ...
            						    ?>
            								<tr>
            									...
            									<td>
            										<input type="radio" name="presensi_pelajaran_status<?php echo $row['student_id']?>[]" class="hadir" value="H" requied>
            									</td>
            									<td>
            										<input type="radio" name="presensi_pelajaran_status<?php echo $row['student_id']?>[]" class="sakit" value="S" requied>
            									</td>
            									<td>
            										<input type="radio" name="presensi_pelajaran_status<?php echo $row['student_id']?>[]" class="izin" value="I" requied>
            									</td>
            									<td>
            										<input type="radio" name="presensi_pelajaran_status<?php echo $row['student_id']?>[]" class="alpha" value="A" requied></td>
            								</tr>
            							<?php endforeach ?>
                                        </tbody>
            						</table>
