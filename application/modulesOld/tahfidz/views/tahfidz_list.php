							...
							<div class="tab-content">
								<div class="tab-pane active" id="tab_1">
                					...
                					<div class="row">
                					    ...
                					    <div class="col-md-6">
                						<div class="form-group">
                							<label>Halaqoh 2</label>
                							<input type="text" class="form-control" required="" name="tahfidz_murojaah" class="form-control" placeholder="Halaqoh 2">
                						</div>
                					    </div>
                						
                					    <div class="col-md-6">
                						<div class="form-group">
                							<label>Halaqoh 3</label>
                							<input type="text" class="form-control" required="" name="tahfidz_murojaah_note" class="form-control" placeholder="Halaqoh 3">
                						</div>
                					    </div>
										...
										<table class="table table-bordered" style="white-space: nowrap;">
											...
											<tbody>
												...
												<tr>
													...
													<td><?php echo $row['tahfidz_murojaah_note'] ?></td>
													<td>
