    ...
    <div class="row">
                        ...
                        <div class="adjust1"> 
                            <div class="caption"> 
                              <p class="text-info lead adjust2">
                                  <img src="<?php echo base_url()."uploads/information/".$row['information_img'] ?>" width="100%">
      ...
      <div class="col-md-3 col-sm-6 col-xs-12">
        <div class="info-box">
          ...
          <div class="info-box-content">
            <span class="info-box-text dash-text">Tagihan Bulan <?php echo pretty_date(date('d-m-Y'), 'F', false) ?></span>
      ...
      <div class="col-md-3 col-sm-6 col-xs-12">
        <div class="info-box">
          ...
          <div class="info-box-content">
            <span class="info-box-text dash-text">Tagihan Lainnya</span>
