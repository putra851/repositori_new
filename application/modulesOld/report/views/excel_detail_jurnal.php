<?php 
    ...
    header("Content-Disposition: attachment; filename = Laporan-per-Jenis-Anggaran-Kas-Tunai-per-Tanggal-".pretty_date($ds, 'd/m/Y', FALSE)."-Sampai-".pretty_date($de, 'd/m/Y', FALSE).".xls");
...
<table style='border-bottom: 1px solid #999999; padding-bottom: 10px; width: 190mm;'>
	...
	<table cellpadding='0' cellspacing='0' style='width: 190mm;'>
		<tr>
			<td style='font-size: 8pt; text-align: left'>Unit Sekolah : </td>
			<td style='font-size: 8pt; text-align: left'><?php echo $unit ?></td>
			<td colspan="6" style='font-size: 8pt; text-align: center'></td>
		</tr>
	</table>
	<br>
	<table style='width: 190mm;'>
		<tr>
			...
			<td colspan="6" style='font-size: 8pt; text-align: center' valign='top' align='center'><b><?php echo 'Laporan per Jenis Anggaran (Kas Tunai) per Tanggal '.pretty_date($ds, 'd F Y', FALSE).' Sampai '.pretty_date($de, 'd F Y', FALSE) ?></b></td>
