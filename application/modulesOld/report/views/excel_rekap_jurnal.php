<?php 
    ...
    header("Content-Disposition: attachment; filename=Rekap-Laporan-Kas-Tunai-per-Tanggal-".pretty_date($ds, 'd/m/Y', FALSE)."-Sampai-".pretty_date($de, 'd/m/Y', FALSE).".xls");
...
<table style='border-bottom: 1px solid #999999; padding-bottom: 10px; width: 190mm;'>
	...
	<table style='width: 190mm;'>
		<tr>
			...
			<td colspan='5' style='font-size: 8pt; text-align: center' valign='top' align='center'><b><?php echo 'Rekap Laporan (Kas Tunai) per Tanggal '.pretty_date($ds, 'd F Y', FALSE).' Sampai '.pretty_date($de, 'd F Y', FALSE) ?></b></td>
