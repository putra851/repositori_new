	...
	<table>
		...
		<table style="border-style: solid;">
			<tr>
				...
				<th style="border-top: 1px solid; border-bottom: 1px solid;">Jam</th>
				<th style="border-top: 1px solid; border-bottom: 1px solid;">Pengunjung</th>
			</tr>
			<?php
				$i =1;
			...
			<tr>
				...
				<td style="border-bottom: 1px solid;"><?php echo pretty_date($row['guest_list_date'], 'd F Y', false) ?></td>
				<td style="border-bottom: 1px solid;"><?php echo $row['guest_list_time'] ?></td>
			...
			<?php 
				...
				endforeach ?>
			<tr>
				<td colspan="3" style="background-color: #dedede; font-weight:bold; border-bottom: 1px solid;">Total Dikunjungi</td>
				<td style="background-color: #dedede;font-weight:bold;border-bottom: 1px solid;">
				    <?php    
						foreach ($visitSum as $row){
						    echo $row['guestlistSum'] . ' Kali';
						}
					?>
				</td>
			</tr>
