								...
								if (!empty($majors)) {
									...
									foreach ($majors as $row):
										...
										<tr>
											...
											<td><?php echo ($row['majors_status'] == '1')? 'Aktif' : 'Tidak Aktif' ?></td>
											<td>
												...
												<?php if($row['majors_status']!=1){ ?>
													<a href="<?php echo site_url('manage/majors/majors_active/' . $row['majors_id']) ?>" class="btn btn-xs btn-success" data-toggle="tooltip" title="Aktifkan"><i class="fa fa-check"></i></a>
										<?php } else { ?>
												<a href="<?php echo site_url('manage/majors/majors_nonactive/' . $row['majors_id']) ?>" class="btn btn-xs btn-primary" data-toggle="tooltip" title="Non-Aktifkan"><i class="fa fa-close"></i></a>
										<?php } ?>
											</td>	
										</tr>
			...
			<div class="modal-dialog modal-md">
				<div class="modal-content">
					<div class="modal-header">
						...
						<h4 class="modal-title">Tambah Unit Sekolah</h4>
					</div>
						...
						<div id="p_scents_majors">
								<div class="row">
									<div class="col-md-6">
										...
										<input type="text" required="" name="majors_name[]" class="form-control" placeholder="Contoh: Sekolah Dasar Putra">
									</div>
									<div class="col-md-6">
										<label>Singkatan</label>
										<input type="text" required="" name="majors_short_name[]" class="form-control" placeholder="Contoh: SD Putra">
									</div>
									<div class="col-md-6">
                						<label>Status</label>
                						<div class="radio">
                							<label>
                								<input type="radio" name="majors_status[]" value="1"> Aktif
                							</label> &nbsp;&nbsp;&nbsp;&nbsp;
                							<label>
                								<input type="radio" name="majors_status[]" value="0" checked> Tidak Aktif
                							</label>
                						</div>
                					</div>
								</div>
