...
// Siswa
  ...
  function add_slip(){
    if ($_POST == TRUE) {
			...
			$paramssubsatu['subsatu_jabatan']        = $this->input->post('premier_jabatan');
            $paramssubsatu['subsatu_pengabdian']     = $this->input->post('premier_pengabdian');
            $paramssubsatu['subsatu_sertifikat']     = $this->input->post('premier_sertifikat');
            $paramssubsatu['subsatu_insentif']       = $this->input->post('premier_insentif');
            $paramssubsatu['subsatu_kitab']          = $this->input->post('premier_kitab');
            $paramssubsatu['subsatu_malam']          = $this->input->post('premier_malam');
            $paramssubsatu['subsatu_mengajar']       = $this->input->post('premier_mengajar');
            $paramssubsatu['subsatu_transport']      = $this->input->post('premier_transport');
            $paramssubsatu['subsatu_lain']           = $this->input->post('premier_lain');
            $paramssubsatu['subsatu_gaji_id']        = $q['gaji_id'];
      
            $paramssubtiga['subtiga_ikbal']          = $this->input->post('potongan_ikbal');
            $paramssubtiga['subtiga_jenguk']         = $this->input->post('potongan_jenguk');
            $paramssubtiga['subtiga_takziyah']       = $this->input->post('potongan_takziyah');
            $paramssubtiga['subtiga_bpjs']           = $this->input->post('potongan_bpjs');
            $paramssubtiga['subtiga_voucher']           = $this->input->post('potongan_voucher');
